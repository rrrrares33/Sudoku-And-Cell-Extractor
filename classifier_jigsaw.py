...
class Classifier:
    def __init__(self):
        ...
        train_labels = self.readLabels("training_data_jigsaw.txt")
        ...
        '''
        validation_labels = self.readLabels(("validation_data_jigsaw.txt"))
    ...
    def readImages(self):
        ...
        for i in range(3988):
            if i > 99:
                aux_file_name = "./training_data_jigsaw/image" + str(i) + ".png"
            elif i > 9:
                aux_file_name = "./training_data_jigsaw/image0" + str(i) + ".png"
            else:
                aux_file_name = "./training_data_jigsaw/image00" + str(i) + ".png"
    ...
    def readImages2(self):
        images = []
        for i in range(3238, 3988):
            aux_file_name = "./validation_data_jigsaw/image" + str(i) + ".png"
            aux_image = cv2.imread(aux_file_name, 0)
            if aux_image is not None:
                aux_image = cv2.resize(aux_image, (75, 75))
                images.append(aux_image)
