import os
def evaluate_results_task1(predictions_path,ground_truth_path,verbose = 1):
    total_correct = 0
    for i in range(1,21):
...
predictions_path_root = "./fisiere_solutie/Gherasim_Rares_343/"
ground_truth_path_root = "./Tema1/antrenare/"
